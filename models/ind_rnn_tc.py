...
# load data
x_train, y_train = load_data("../dbpedia_data/dbpedia_csv/train.csv", sample_ratio=1e-2)
x_test, y_test = load_data("../dbpedia_data/dbpedia_csv/test.csv", sample_ratio=1e-2)
